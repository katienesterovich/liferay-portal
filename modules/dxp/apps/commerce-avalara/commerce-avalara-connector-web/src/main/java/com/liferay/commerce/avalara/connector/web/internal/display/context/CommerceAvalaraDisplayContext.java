...
public class CommerceAvalaraDisplayContext {
	...
	public List<NavigationItem> getNavigationItems() {
		...
		String viewWeightProductMeasurementUnitsURL = getNavigationItemURL(
			"view-entity-use-codes",
			CommerceAvalaraConstants.TYPE_ENTITY_USE_CODES);
		...
		NavigationItem entityUseCodesNavigationItem = getNavigationItem(
			toolbarItem.equals("view-entity-use-codes"),
			viewWeightProductMeasurementUnitsURL,
			LanguageUtil.get(resourceBundle, "entity-use-codes"));

		navigationItems.add(credentialsNavigationItem);
		navigationItems.add(entityUseCodesNavigationItem);
